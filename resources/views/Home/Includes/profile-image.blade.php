<div class="border p-1 profile-image" style="position: relative">
    ...
    <a id="image-button" style="position:absolute;bottom: 0;right: 0" class="p-2"><i class="fa fa-camera"></i> Update
        profile Picture</a>
